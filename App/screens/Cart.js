      ...
      {Object.keys(items).length === 0 || products.length === 0 ? (
        ...
        >
          ...
          >
            ...
            >
              <Image source={bag1} style={{ width: 240, height: 240 }} />
            </View>
            <View
              style={{
                paddingVertical: 80,
            ...
            <Divider width={1} color="#9ca3af" />
            <BottomTabs navigation={navigation} activeTab="Cart" />
        </ImageBackground>
      ) : (
        <ImageBackground
          style={{
                ...
                return (
                  <View key={index}>
                    <CartProduct
                      ...
                      name={product.name}
                      price={product.price}
                      sumPrice={getSum(product.price, product._id)}
                      id={product._id}
